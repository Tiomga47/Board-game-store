...
namespace Magaz
{
    public partial class Puzzle : Form
    {
        public Puzzle()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM puzzledata", db.getConnection());
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM puzzledata WHERE number = @number", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM puzzledata WHERE puzzledata.number = @number", db.getConnection());
