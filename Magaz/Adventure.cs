...
namespace Magaz
{
    public partial class Adventure : Form
    {
        public Adventure()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM adventuredata", db.getConnection());
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM adventuredata WHERE number = @number", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM adventuredata WHERE adventuredata.number = @number", db.getConnection());
