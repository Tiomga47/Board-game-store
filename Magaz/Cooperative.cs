...
namespace Magaz
{
    public partial class Cooperative : Form
    {
        public Cooperative()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM cooperativedata", db.getConnection());
...
#region label for delete
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM cooperativedata WHERE number = @number", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM cooperativedata WHERE cooperativedata.number = @number", db.getConnection());
        ...
        #endregion
        private void Cooperative_Load(object sender, EventArgs e)
        {
