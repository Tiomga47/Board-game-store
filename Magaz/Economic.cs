...
namespace Magaz
{
    public partial class Economic : Form
    {
        public Economic()
        {
            InitializeComponent();
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM economicdata", db.getConnection());
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM economicdata WHERE number = @number", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM economicdata WHERE economicdata.number = @number", db.getConnection());
        ...
        private void Economic_Load(object sender, EventArgs e)
        {
