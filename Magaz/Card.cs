...
namespace Magaz
{
    public partial class Card : Form
    {
        public Card()
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT * FROM datacard", db.getConnection());
            db.openConnection();
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            DataTable table = new DataTable();
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            MySqlCommand command = new MySqlCommand("SELECT * FROM datacard WHERE number = @number", db.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                MySqlCommand command1 = new MySqlCommand("DELETE FROM datacard WHERE datacard.number = @number", db.getConnection());
